...
import { c as create_ssr_component, d as createEventDispatcher, o as onDestroy, b as add_attribute, e as escape, v as validate_component } from "../../chunks/ssr.js";
...
const Particles2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `  <div${add_attribute("id", id, 0)}${add_attribute("class", cssClass, 0)}${add_attribute("style", style, 0)}></div>`;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $metadata, $$unsubscribe_metadata;
  $$unsubscribe_metadata = subscribe(metadata, (value) => $metadata = value);
  set_store_value(metadata, $metadata.description = "Discover how mind.ai empowers you to nurture, organize, and grow your ideas into something beautiful through AI-powered journaling and the Mind Gardens methodology.", $metadata);
  let particlesConfig = {
    particles: {
      color: { value: "#ffffff" },
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1fs0kb1_START -->${$$result.title = `<title>${escape($metadata.title)}</title>`, ""}<meta name="description"${add_attribute("content", $metadata.description, 0)}><!-- HEAD_svelte-1fs0kb1_END -->`, ""}  ${validate_component(Particles2, "Particles").$$render(
    $$result,
    {
      id: "tsparticles",
    ...
    {},
    {}
  )}  <div class="hero min-h-screen" style="background-image: url(img/treeBrain.png);" data-svelte-h="svelte-okzwtj"><div class="hero-overlay bg-opacity-60"></div> <div class="hero-content text-neutral-content text-center"><div class="max-w-md"><h1 class="mb-5 text-5xl font-bold">Transform Your Thoughts into a Flourishing Mind Garden with AI</h1> <p class="mb-5">Discover how mind.ai empowers you to nurture, organize, and grow your
        ideas into something beautiful.</p> <button class="btn btn-primary">Plant Your First Thought Today</button></div></div></div>  <div class="bg-base-100 py-16"><div class="container mx-auto px-4 sm:px-6 lg:px-8"><div class="mb-12 text-center" data-svelte-h="svelte-qv1oad"><h2 class="mb-4 text-4xl font-bold">Cultivate Your Mental Ecosystem</h2> <p class="text-xl">In the Mind Gardens methodology, each thought or idea is a seed that can
        ...
        ecosystem.</p></div> <div class="flex justify-center"><img src="img/mindgarden.png" alt="Mind Garden Infographic" class="w-full max-w-screen-md rounded-xl object-cover shadow-xl"></div></div></div>  <div class="bg-base-200 py-16" id="features"><div class="container mx-auto px-4 sm:px-6 lg:px-8"><div class="grid grid-cols-1 gap-8 md:grid-cols-2"><div class="flex items-center justify-center" data-svelte-h="svelte-1w71hq2"><img src="img/cave.png" alt="Thought Capture Demo" class="h-96 w-full object-cover"></div> <div data-svelte-h="svelte-4s6q5t"><h3 class="mb-4 text-3xl font-bold">Effortless Thought Capture</h3> <p class="mb-4">Quickly jot down your ideas and watch them grow visually in your mind
          garden. The intuitive interface makes it easy to capture and organize
          your thoughts.</p> <h3 class="mb-4 text-3xl font-bold">Personalized AI Assistance</h3> <p class="mb-4">Our AI learns from your unique thought patterns and suggests prompts
          to help your ideas flourish. It&#39;s like having a personal gardener for
          your mind.</p> <h3 class="mb-4 text-3xl font-bold">Private and Secure</h3> <p>Your mind garden is your private oasis. We use state-of-the-art
          encryption to ensure your thoughts remain confidential and secure.</p></div></div></div></div>  <div class="bg-base-100 py-16" id="how-it-works"><div class="container mx-auto px-4 sm:px-6 lg:px-8"><div class="mb-12 text-center" data-svelte-h="svelte-12um87m"><h2 class="mb-4 text-4xl font-bold">How mind.ai Works</h2> <p class="text-xl">Our AI-powered journaling process is simple and intuitive.</p></div> <div class="grid grid-cols-1 gap-8 md:grid-cols-3" data-svelte-h="svelte-m6vzm1"><div class="card bg-base-200 shadow-xl"><figure class="px-10 pt-10"><img src="img/waterfall.png" alt="Capture Icon" class="rounded-xl"></figure> <div class="card-body items-center text-center"><h3 class="card-title">1. Capture</h3> <p>Jot down your thoughts, ideas, and experiences in the app.</p></div></div> <div class="card bg-base-200 shadow-xl"><figure class="px-10 pt-10"><img src="img/thoughts.png" alt="Nurture Icon" class="rounded-xl"></figure> <div class="card-body items-center text-center"><h3 class="card-title">2. Nurture</h3> <p>Our AI provides personalized prompts and insights to help your ideas
            grow.</p></div></div> <div class="card bg-base-200 shadow-xl"><figure class="px-10 pt-10"><img src="img/mountain.png" alt="Flourish Icon" class="rounded-xl"></figure> <div class="card-body items-center text-center"><h3 class="card-title">3. Flourish</h3> <p>Watch your thoughts blossom into a beautiful mind garden.</p></div></div></div></div></div>  <div class="bg-base-200 py-16" id="pricing"><div class="container mx-auto px-4 sm:px-6 lg:px-8"><div class="mb-12 text-center" data-svelte-h="svelte-8pm2pf"><h2 class="mb-4 text-4xl font-bold">Simple, Transparent Pricing</h2> <p class="text-xl">Choose the plan that best fits your needs.</p></div> <div class="grid grid-cols-1 gap-8 md:grid-cols-3" data-svelte-h="svelte-1vizo2c"></div></div></div>  <div class="bg-base-100 py-16" id="testimonials" data-svelte-h="svelte-1am1hr"><div class="container mx-auto px-4 sm:px-6 lg:px-8"><h2 class="mb-12 text-center text-4xl font-bold">What Our Users Say</h2> <div class="grid grid-cols-1 gap-8 md:grid-cols-2"></div></div></div>  <div class="bg-base-200 py-16" id="contact"><div class="container mx-auto px-4 sm:px-6 lg:px-8"><div class="mb-12 text-center" data-svelte-h="svelte-1ieq1ze"><h2 class="mb-4 text-4xl font-bold">Get in Touch</h2> <p class="text-xl">Have a question or want to learn more? We&#39;d love to hear from you!</p></div> <div class="flex justify-center" data-svelte-h="svelte-e04g5h"></div></div></div>  <footer class="footer footer-center bg-base-100 text-base-content rounded p-10" data-svelte-h="svelte-1mph5ib"></footer>`;
});
export {
  Page as default
};
