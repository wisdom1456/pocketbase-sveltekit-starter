import { c as compute_rest_props, s as subscribe, a as set_store_value, i as is_promise, n as noop } from "../../../chunks/utils.js";
import { c as create_ssr_component, e as each, v as validate_component, m as missing_component, d as escape, g as getContext, b as add_attribute, a as createEventDispatcher, s as setContext } from "../../../chunks/ssr.js";
  ...
  return `${validate_component(LoginGuard, "LoginGuard").$$render($$result, {}, {}, {
    default: () => {
      return `${each(posts, (post) => {
        return `<div class="card flex w-full flex-col justify-between bg-base-300 p-4 shadow-xl"><div><figure>${function(__value) {
        ...
        }(getFeaturedImageUrl(post))}</figure> <div class="m-4 max-w-xl"><div class="prose items-center gap-x-4" data-svelte-h="svelte-189i4nw"></div> <div class="group relative mt-3"><a${add_attribute("href", `/posts/${post.slug}`, 0)} class="prose-lg line-clamp-2 font-bold text-primary">${escape(post.title)}</a> <div class="prose-sm mt-3 line-clamp-6 text-justify text-base-content">${validate_component(SvelteMarkdown, "Markdown").$$render($$result, { source: post.blogSummary || post.body }, {}, {})} </div></div> </div></div> </div>`;
      })} ${posts.length === 0 ? `<div class="card flex w-full flex-col justify-between bg-base-300 p-4 shadow-xl" data-svelte-h="svelte-18kunlo"><div><div class="m-4 max-w-xl"><div class="prose items-center gap-x-4"><div class="text-accent">No posts found</div></div></div></div></div>` : ``}`;
    }
  })}`;
});
export {
