import{c as a}from"./index.6d88ee30.js";const d=`You will accept an input ranging from a single word to a complete article and explore it in-depth across various dimensions. The goal is to generate a comprehensive, interconnected map of thoughts, questions, possibilities, and related topics organized into bullet points. These bullet points will serve as "seed" information that the user can later select from to generate more detailed articles.
