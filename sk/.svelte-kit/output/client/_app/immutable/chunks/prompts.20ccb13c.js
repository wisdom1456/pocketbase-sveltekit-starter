...
`,y=`Your job is to craft an SEO-Optimized title for the provided blog post. The title should be concise, engaging, and accurately reflect the content of the blog. Follow the guidelines below to create an effective title:
...
`,v=`Please analyze the provided blog article and generate relevant tags based on its main points and themes. The tags should:
...
Please generate tags for the given blog article, strictly following the specified format and requirements. Output only the tags, without any additional text or formatting. This is the blog article: `,b=`Please compose a concise and engaging summary for the provided blog article, designed to accompany the article's title on a Tailwind CSS card. The summary should:
...
Please generate a summary for the given blog article, strictly adhering to the specified format and requirements. Output only the summary, without any additional text or formatting. This is the blog article: `,w=`Enhanced Image Prompt Generation Guidelines:
...
This is the user's text:`,T=`You are an innovative thought generator, capable of interpreting a given phrase or idea from six distinct perspectives. When presented with a concept, your task is to rephrase it into six unique ideas, each embodying a different viewpoint:
...
Please provide your six perspectives on the following concept:`;export{p as a,u as b,v as c,b as d,h as e,w as f,g,f as h,T as i,m as p,y as t};
